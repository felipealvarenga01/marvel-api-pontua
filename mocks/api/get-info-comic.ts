...
const mockHeroComics = {
  ...
  etag: "a8f760bf4da1750769d3e661159cb5123fff80f6",
  data: {
  offset: 0,
    limit: 20,
    total: 1,
    ...
    results: [
    {
      ...
      urls: [
        {
          type: "detail",
          url: "http://marvel.com/comics/issue/22506/avengers_the_initiative_2007_19?utm_campaign=apiRef&utm_source=cbafb01a70062ac3ab2577aca097c933"
        },
        {
          type: "purchase",
          url: "http://comicstore.marvel.com/Avengers-The-Initiative-19/digital-comic/10949?utm_campaign=apiRef&utm_source=cbafb01a70062ac3ab2577aca097c933"
        },
        {
          type: "reader",
          url: "http://marvel.com/digitalcomics/view.htm?iid=10949&utm_campaign=apiRef&utm_source=cbafb01a70062ac3ab2577aca097c933"
        },
        {
          type: "inAppLink",
          url: "https://applink.marvel.com/issue/10949?utm_campaign=apiRef&utm_source=cbafb01a70062ac3ab2577aca097c933"
        }
      ],
      series: {
...
const enableMock = () => {
  fetchMock.mock({
    ...
    url: new RegExp('/comics/comic-id')
  })
}