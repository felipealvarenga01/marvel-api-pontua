    ...
    results: [
      {
        ...
        urls: [
          {
            type: 'detail',
            url: 'http://marvel.com/comics/events/269/secret_invasion?utm_campaign=apiRef&utm_source=cbafb01a70062ac3ab2577aca097c933',
          },
          {
            type: 'wiki',
            url: 'http://marvel.com/universe/Secret_Invasion?utm_campaign=apiRef&utm_source=cbafb01a70062ac3ab2577aca097c933',
          },
        ],
        ...
        stories: {
          available: 359,
          collectionURI:
            'http://gateway.marvel.com/v1/public/events/269/stories',
          items: [
            {
        ...
        comics: {
          available: 164,
          collectionURI:
            'http://gateway.marvel.com/v1/public/events/269/comics',
          items: [
            {
        ...
        series: {
          available: 86,
          collectionURI:
            'http://gateway.marvel.com/v1/public/events/269/series',
          items: [
            {
